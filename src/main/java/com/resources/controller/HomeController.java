...
public class HomeController {
	...
	public ModelAndView loginCheck(
		...
		JobSeeker jobSeeker = (JobSeeker) session.getAttribute("loggedInUser");
		System.out.println("kdjnfnksjndsknfksdjfnjs");
		if (jobSeeker != null) {
